...
\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{ada-ein-g.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{ada-ein.png}
\caption{$t$ versus $E_{in}(G_t)$}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{ada-ut.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{ada-epsilon.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{ada-eout-g.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{ada-eout.png}
\caption{$t$ versus $E_{out}(G_t)$}
\label{fig:ada-eout}
\end{figure}
